      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground font-body text-lg leading-relaxed mb-3">
            Vou analisar seu perfil e identificar os pontos que estão impedindo você de atrair clientes.
          </p>
          <p className="text-muted-foreground font-body text-base leading-relaxed mb-10">
            E te mostrar exatamente o que precisa ser ajustado para gerar mais resultados.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
